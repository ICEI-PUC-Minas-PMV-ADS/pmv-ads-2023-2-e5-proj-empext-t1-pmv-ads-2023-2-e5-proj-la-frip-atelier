...
|-------|-------------------------
|Requisitos Associados | RF-02: Disponibilizar um sistema de recuperação de senha, onde o usuário poderá criar uma nova senha com dados válidos e realizar login.
...
|-------|-------------------------
|Requisitos Associados | RF-03: Disponibilizar um sistema de cadastro de parceiras afim de ter um controle sobre pagamentos e produtos relacionados.
...
|-------|-------------------------
|Requisitos Associados | RF-04: Disponibilizar um sistema de cadastro de produtos afim de ter um controle sobre pagamentos e parceiras relacionados.
...
|-------|-------------------------
|Requisitos Associados | RF-05: Disponibilizar um sistema de consulta de produtos cadastrados afim de ter um controle sobre pagamentos e parceiras relacionados.
