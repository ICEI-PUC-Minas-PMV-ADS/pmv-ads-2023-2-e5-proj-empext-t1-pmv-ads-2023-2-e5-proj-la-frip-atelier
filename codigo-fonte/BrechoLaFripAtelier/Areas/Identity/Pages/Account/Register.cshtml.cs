...
namespace BrechoLaFripAtelier.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [MaxLength(50, ErrorMessage = "0 tamanho máximo do campo {0} é de {1} caracteres")]
            [Required]
            public string Nome { get; set; }

            [MaxLength(15, ErrorMessage = "0 tamanho máximo do campo {0} é de {1} caracteres")]
